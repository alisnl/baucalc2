...
To build the final jar and optimize the baucalc2 application for production, run:
...
Then navigate to [http://localhost:8484](http://localhost:8484) in your browser.
